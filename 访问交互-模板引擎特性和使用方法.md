...
比如说：http://www.speedphp.com/bbs/forum-6-1.html，这个网址浏览器的当前访问目录，是http://www.speedphp.com/bbs/，如果该网页上面有这样一张图片：

	<img src="images/logo.gif" alt="" />
	
那么，这张图片就称为“相对路径”，可以认为，通过以下地址就可以访问到这张图片：http://www.speedphp.com/bbs/images/logo.gif。
